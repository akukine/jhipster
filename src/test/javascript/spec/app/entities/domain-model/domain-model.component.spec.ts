...
import { DomainModelComponent } from 'app/entities/domain-model/domain-model.component';
...
describe('Component Tests', () => {
  describe('DomainModel Management Component', () => {
    let comp: DomainModelComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DomainModelComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(DomainModelComponent);
      comp = fixture.componentInstance;
      service = fixture.debugElement.injector.get(DomainModelService);
    });
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.domainModels[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
